...
export class AssetDetailComponent implements OnInit {
          ...
          if(id!=="new"){
             ...
             this.httpService.getDetailViaIDAsset(id).subscribe(data=>
              {   
                 ...
                 this.deliveryDate=this.detailContent.deliveryDate,
                 ...
                 this.purchaseDate=this.detailContent.purchaseDate,
  ...
  loadList(){
    let dataParam = this.parameterGenerator(this.currentPage, this.showAll,this.searchBy, this.keyword, this.orderBy, this.orderType);
